...
```
           URI = séma ":" hierarchikus [ "?" query ] [ "#" fragment ]

  hierarchikus = "//" authority path-abempty
                / path-absolute
                / path-rootless
                / path-empty
```
...
segment-nz-nc = 1*( nem-fenntartott / url-kódolt / más-határolók / "@" )
                ; nem 0 hosszúságú szegmens, kettőspont nélkül ":"
