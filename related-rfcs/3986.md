...
melyek a nem hierarchikus lekérdezés komponens adatai mellett az erőforrás
azonosításra szolgálnak. Az útvonal komponens az első kérdőjelig ("?")
vagy kettős keresztig ("#"), ezek hiányában az URI végéig tart.
...
```
  path                  = hitelesítési-útvonal
                          / abszolút-útvonal
                          / nincs-séma-útvonal
                          / relatív-útvonal
                          / üres-útvonal

  hitelesítési-útvonal  = *( "/" szegmens )
...
within the query component. However, as query components
