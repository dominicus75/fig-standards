...
tett [IP-literálal](https://hu.wikipedia.org/wiki/IPv6-c%C3%ADm) (ez az egyetlen hely,
...
[IPv4-címmel](https://hu.wikipedia.org/wiki/IP-c%C3%ADm), illetve a gazdagép regisztrált
doménnevével. A gazdagép részkomponens nem kis-, és nagybetű érzékeny.
