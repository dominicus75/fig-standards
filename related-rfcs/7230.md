...
Általános szabályként az "elavult-" ("obsolete-") előtaggal jelölt ABNF szabálynevek
az olyan elavult nyelvtani szabályokat jelölnek, amelyek történelmi (kegyeleti, babonás, stb.)
okokból jelennek meg a specifikációban.
